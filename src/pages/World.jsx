function World() {
    const publicaciones = [
        {
            ...
            titulo: "Feature post",
            fecha: "Nov 12",
            cuerpo: "This is a wider card with supporting text below as a natural lead-in to additional content."
        },
        {
            tag: "Design",
            titulo: "Post tile",
    ...
    return (<main className="container">
        ...
        <div className="row mb-2">
            {/* Crear un componente para tarjetas de publicaciones */}
            {
                publicaciones.map((publicacion, index) => {
                    return (<div className="col-md-6" key={index}>
                        <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                            <div className="col p-4 d-flex flex-column position-static">
                                <strong className="d-inline-block mb-2 text-primary-emphasis">{publicacion.tag}</strong>
                                <h3 className="mb-0">{publicacion.titulo}</h3>
                                <div className="mb-1 text-body-secondary">{publicacion.fecha}</div>
                                <p className="card-text mb-auto">{publicacion.cuerpo}</p>
            ...
            <div className="col-md-8">
                ...
                <article className="blog-post">
                    ...
                    <ul>
                        ...
                        <li>Abbreviations, like <abbr title="HyperText Markup Language">HTML</abbr> should use <code className="language-plaintext highlighter-rouge">&lt;abbr&gt;</code>, with an optional <code className="language-plaintext highlighter-rouge">title</code> attribute for the full phrase.
                        </li>
                        <li>Citations, like <cite>— Mark Otto</cite>, should use <code className="language-plaintext highlighter-rouge">&lt;cite&gt;</code>.</li>
                        <li><del>Deleted</del> text should use <code className="language-plaintext highlighter-rouge">&lt;del&gt;</code> and <ins>inserted</ins>
                            text should use <code className="language-plaintext highlighter-rouge">&lt;ins&gt;</code>.</li>
                        <li>Superscript <sup>text</sup> uses <code className="language-plaintext highlighter-rouge">&lt;sup&gt;</code> and subscript
